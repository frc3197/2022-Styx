...
public class RangeLookup {
    ...
    public static RangePair getRangePair(double range) {
        ...
        switch (normalizeRange(range)) {
            case 70:
                rangePair = new VoltagePair(-340, 7.2);
                break;
            case 75:
                rangePair = new VoltagePair(-340, 7.4);
                break;
            case 80:
                rangePair = new VoltagePair(-520, 7);
                break;
            case 85:
                rangePair = new VoltagePair(-585, 7);
                break;
            case 90:
                rangePair = new VoltagePair(-495, 7.5);
                break;
            // VERIFY THIS RANGE
            case 95:
            ...
            // Stopped Here
            case 100:
                rangePair = new VoltagePair(-550, 7.5);
                break;
            case 105:
                rangePair = new VoltagePair(-550, 7.5);
                break;
            case 110:
                rangePair = new VoltagePair(-555, 7.6);
                break;

            case 115:
                rangePair = new VoltagePair(-565, 7.4);
                break;
            case 120:
                rangePair = new VoltagePair(-605, 7.4);
                break;
            case 125:
                rangePair = new VoltagePair(-605, 7.55);
                break;
            case 130:
                rangePair = new VoltagePair(-650, 7.65);
                break;

            case 135:
                rangePair = new VoltagePair(-650, 7.75);
                break;
            case 140:
                rangePair = new VoltagePair(-650, 7.85);
                break;
            ...
            case 145:
                ...
                break;
            case 150:
                rangePair = new VoltagePair(-690, 7.9);
                break;
            case 155:
                rangePair = new VoltagePair(-690, 8.1);
                break;
            case 160:
                rangePair = new VoltagePair(-690, 8.2);
                break;
            case 165:
                rangePair = new VoltagePair(-690, 8.3);
                break;
            ...
            break;
            case 175:
            rangePair = new VoltagePair(-710, 8.8);
            break;
            case 180:
